...
public class EmiratesAgent extends Agent {
    private List<Flight> availableFlights = Arrays.asList(
            new Flight("7", "Jijel", "Dubai", "18/12/2024", 650, 300, "Emirates"),
            new Flight("8", "Algiers", "Dubai", "22/12/2024", 750, 400, "Emirates")
    );

    protected void setup() {
        System.out.println("Emirates Agent started: " + this.getAID().getName());
