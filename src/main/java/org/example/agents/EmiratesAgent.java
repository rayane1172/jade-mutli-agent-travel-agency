...
public class EmiratesAgent extends Agent {

    private double initialPrice = 800.0; // Initial price for the flight
    private double minimumPrice = 550.0; // Minimum price the airline can offer
    ...
    protected void setup() {
        System.out.println("Air Emirate Agent started: " + this.getAID().getName());
...
//                            System.out.println("Performative inconnue : " + message.getPerformative());
    ...
    private void initializeAvailableFlights() {
        availableFlights.add(new Flight("EK101", "Dubai", "London", "12/01/2025",2,"AirEmirates",0));
        availableFlights.add(new Flight("EK202", "Dubai", "Paris", "15/01/2025",2,"AirEmirates",0));
        availableFlights.add(new Flight("EK303", "Dubai", "New York", "20/01/2025",3,"AirEmirates",0));
    }
...
//                System.out.println("flight_choosed Json sended with accept propsal");
    ...
    protected void takeDown() {
        System.out.println("Emirates Agent shutting down.");
    }
