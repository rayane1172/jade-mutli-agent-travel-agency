...
public class QatarAirwaysAgent extends Agent {
    private List<Flight> availableFlights = Arrays.asList(
            new Flight("5", "Jijel", "Doha", "18/12/2024", 600, 350, "Qatar Airways"),
            new Flight("6", "Algiers", "Doha", "20/12/2024", 700, 400, "Qatar Airways")
    );

    protected void setup() {
        System.out.println("Qatar Airways Agent started: " + this.getAID().getName());
