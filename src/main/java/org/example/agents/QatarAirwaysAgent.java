...
public class QatarAirwaysAgent extends Agent {

    private double initialPrice = 750.0; // Default initial price for the flight
    ...
    protected void setup() {
        System.out.println("Air QATAR Agent started: " + this.getAID().getName());
...
//                            System.out.println("vol request recevied in QATAR => "+volRequestReceived);
...
//                            System.out.println("Performative inconnue : " + message.getPerformative());
    ...
    private void initializeAvailableFlights() {
        // Add some sample flights to the availableFlights list for Qatar Airways
        availableFlights.add(new Flight("QR101", "Algiers", "Paris", "15/01/2025",10,"QATARAIRWAYS",0));
        availableFlights.add(new Flight("QR102", "Doha", "London", "16/01/2025",20,"QATARAIRWAYS",0));
        availableFlights.add(new Flight("QR103", "Doha", "Madrid", "17/01/2025",30,"QATARAIRWAYS",0));
        availableFlights.add(new Flight("QR104", "Doha", "New York", "20/01/2025",40,"QATARAIRWAYS",0));
    }
    ...
    private void handleFlightRequest(ACLMessage message) {
        ...
        if (flight_found != null) {
            ...
            send(reply);
            System.out.println("Air QATAR proposed initial price: " + initialPrice);
    ...
    private void handleOffer(ACLMessage message) {
        ...
        System.out.println("Air QATAR received counteroffer: " + offre);
...
//                System.out.println("flight_choosed Json sended with accept propsal");
            ...
            send(reply);
            System.out.println("Air QATAR proposed new price: " + newPrice);
...
//            takeDown();
    ...
    protected void takeDown() {
        System.out.println("Qatar Airways Agent shutting down.");
    }
}
